 ...
 *   3. Rendimientos table (1D / MTD / YTD / 13M with TNA)
 *   4. Honorarios row (when available)
 *   5. Absolute footer — CNV disclaimer
 */
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.footer} fixed>
          <Text style={s.footerText}>
            ...
            Datos: planilla diaria oficial de CAFCI (cafci.org.ar) — verificar siempre con la fuente oficial.
          </Text>
        </View>
